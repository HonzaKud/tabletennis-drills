...
import { inviteRepo } from "@/server/repositories";

export const dynamic = "force-dynamic";
export const revalidate = 0;

export const metadata: Metadata = {
  title: "Pozvánka | TableTennis Drills",
};
...
export default async function InvitePage({ params }: PageProps) {
  // ✅ Next 16 (Turbopack): params is a Promise
  ...
  // Basic guard for obviously invalid token strings.
            ...
            <div className="rounded-2xl border border-gray-200 bg-white/90 p-6 shadow-xl shadow-black/5 backdrop-blur sm:p-7">
              <div className="mb-6 flex flex-col items-center text-center">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Odkaz na pozvánku vypadá neplatně. Zkontroluj, že je celý a
                  správně zkopírovaný.
                </p>
              </div>
              ...
              <a
                href="/login"
                className="inline-flex w-full items-center justify-center rounded-xl bg-gray-900 px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-gray-800"
              >
  ...
  // Pre-check invite (nicer UX: show "expired/invalid" page immediately).
          ...
          <div className="w-full max-w-md">
            <div className="rounded-2xl border border-gray-200 bg-white/90 p-6 shadow-xl shadow-black/5 backdrop-blur sm:p-7">
              <div className="mb-6 flex flex-col items-center text-center">
                ...
                <h1 className="text-2xl font-semibold tracking-tight text-gray-900">
                  Pozvánka je neplatná nebo expirovaná
                </h1>
                <p className="mt-2 text-sm text-gray-600">
                  Tenhle odkaz už není možné použít. Požádej administrátora o
                  novou pozvánku.
                </p>
              </div>
        ...
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-gray-200 bg-white/90 p-6 shadow-xl shadow-black/5 backdrop-blur sm:p-7">
            <div className="mb-6 flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Nastav si heslo pro účet:{" "}
                <span className="font-medium text-gray-900">{invite.email}</span>
              </p>
            </div>

            <InviteSetPasswordForm token={token} />
